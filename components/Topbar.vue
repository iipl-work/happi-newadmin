...
<template>
<!-- Topbar Start -->
<div class="navbar-custom" style="background:orange">
                ...
                <template slot="button-content" class="nav-link dropdown-toggle">
                    <div class="nav-user mr-0">
                        <span class="pro-user-name ml-1"> 
                            <i class="mdi mdi-chevron-down rounded-circle"></i>
                        </span>
                    </div>
                </template>
        ...
        <div class="logo-box">
            <nuxt-link to="/" class="logo logo-dark text-center">
                <span class="logo-sm">
                    ...
                    <span class="logo-lg-text-light">OneConnect</span>
                </span>
                <span class="logo-lg">
                    <!-- <img src="~/assets/images/logo-dark.png" alt height="20" /> -->
                    <span class="logo-lg-text-light">O</span>
                </span>
            </nuxt-link>
