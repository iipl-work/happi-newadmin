            ...
            <div class="card-body p-4">
                ...
                <form action="#">
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control" type="email" id="phonenumber" required placeholder="Enter your Phone number" />
                    </div>

                   <!-- <div class="form-group mb-3">
                        <label for="password">Password</label>
                        <div class="input-group input-group-merge">
                             <input  v-if="showPassword" type="text" id="password" class="form-control" placeholder="Enter your password" v-model="password"/>
                            <input  v-else type="password" id="password" class="form-control" placeholder="Enter your password" v-model="password" />
                            <div class="input-group-append" data-password="false">
                                <div class="input-group-text">
                                    <span class="password-eye"  @click="toggleShow"></span>
                                </div>
                            </div>
                        </div>
                    </div> -->
