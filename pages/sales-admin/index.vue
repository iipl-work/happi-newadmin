...
<div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                 <!-- <input type="text" v-model="message" placeholder="add multiple lines"/>
              <button @click.prevent="addClusterData" class="btn btn-primary btn-rounded mt-3">Save</button> -->
              
            <a class="btn btn-danger mb-2" href="/sales-admin/register-form"><i class="mdi mdi-plus-circle mr-1"></i>  Add Cluster </a>
                    ...
                    <div class="table-responsive mb-0">
                        <b-table :items="this.clusterData"  :fields="[{ key: 'id', label: 'ID' },{ key: 'clusterName', label: 'clusterName' }, 'clusterCode', 'districtName','status', { key: 'dateCreated', label: 'Date' },{ key: 'actions', label: 'Actions' }]" responsive="sm" :per-page="perPage" :current-page="currentPage" :sort-by.sync="sortBy" :sort-desc.sync="sortDesc" :filter="filter" :filter-included-fields="filterOn" @filtered="onFiltered">
                             ...
                             <template #cell(actions)="row">
                                ...
                                <!-- <a size="md" href="javascript: void(0);" class="mr-1">
